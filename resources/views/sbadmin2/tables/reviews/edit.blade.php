...
<div class="container-xl px-4 mt-4">
    ...
    <nav class="nav nav-borders">
        ...
        <a class="nav-link active" href="{{ route('admin.reviews.edit', $review->id) }}">Edit Review</a>
    </nav>
    <hr class="mt-0 mb-4">
    <div class="row">
        <div class="col-lg-8">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('admin.reviews.update', $review->id) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="comment" value="{{ $review->comment }}" id="comment" placeholder="Enter review comment">
                        </div>
