...
<div class="container-xl px-4 mt-4">
    <nav class="nav nav-borders">
        ...
        <a class="nav-link active" href="{{ route('admin.options.create') }}">Create Option</a>
    </nav>
    <hr class="mt-0 mb-4">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="name" name="name" placeholder="Enter option name">
                        </div>
