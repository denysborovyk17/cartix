            ...
            <div class="row g-4">
                    <div class="col-12 col-sm-6 col-lg-4">
                        ...
                        <div class="card border border-transparent position-relative overflow-hidden h-100 transparent">
                            ...
                            <div class="card-body px-0">
                                <a class="text-decoration-none link-cover" href="product.blade.php">Nike Air VaporMax 2021</a>
                    ...
                    <div class="col-12 col-sm-6 col-lg-4">
                        ...
                        <div class="card border border-transparent position-relative overflow-hidden h-100 transparent">
                            <div class="card-img position-relative">
                                ...
                                <span class="position-absolute top-0 end-0 p-2 z-index-20 text-muted"><i class="ri-heart-line"></i></span>
                                <picture class="position-relative overflow-hidden d-block bg-light">
                                    <img class="w-100 img-fluid position-relative z-index-10" title="" src="/images/products/product-2.jpg" alt="">
                                </picture>
                                    <div class="position-absolute start-0 bottom-0 end-0 z-index-20 p-2">
                                        <button class="btn btn-quick-add"><i class="ri-add-line me-2"></i> Quick Add</button>
                                    </div>
                            ...
                            <div class="card-body px-0">
                                <a class="text-decoration-none link-cover" href="product.blade.php">Nike ZoomX Vaporfly</a>
                    ...
                    <div class="col-12 col-sm-6 col-lg-4">
                        ...
                        <div class="card border border-transparent position-relative overflow-hidden h-100 transparent">
                            <div class="card-img position-relative">
                                ...
                                <span class="position-absolute top-0 end-0 p-2 z-index-20 text-muted"><i class="ri-heart-line"></i></span>
                                <picture class="position-relative overflow-hidden d-block bg-light">
                                    <img class="w-100 img-fluid position-relative z-index-10" title="" src="/images/products/product-3.jpg" alt="">
                                </picture>
                            </div>
                            <div class="card-body px-0">
                                <a class="text-decoration-none link-cover" href="product.blade.php">Nike Blazer Mid &#x27;77</a>
                    ...
                    <div class="col-12 col-sm-6 col-lg-4">
                        ...
                        <div class="card border border-transparent position-relative overflow-hidden h-100 transparent">
                            <div class="card-img position-relative">
                                ...
                                <span class="position-absolute top-0 end-0 p-2 z-index-20 text-muted"><i class="ri-heart-line"></i></span>
                                <picture class="position-relative overflow-hidden d-block bg-light">
                                    <img class="w-100 img-fluid position-relative z-index-10" title="" src="/images/products/product-4.jpg" alt="">
                                </picture>
                                    <div class="position-absolute start-0 bottom-0 end-0 z-index-20 p-2">
                                        <button class="btn btn-quick-add"><i class="ri-add-line me-2"></i> Quick Add</button>
                                    </div>
                            ...
                            <div class="card-body px-0">
                                <a class="text-decoration-none link-cover" href="product.blade.php">Nike Air Force 1</a>
                    ...
                    <div class="col-12 col-sm-6 col-lg-4">
                        ...
                        <div class="card border border-transparent position-relative overflow-hidden h-100 transparent">
                            <div class="card-img position-relative">
                                ...
                                <span class="position-absolute top-0 end-0 p-2 z-index-20 text-muted"><i class="ri-heart-line"></i></span>
                                <picture class="position-relative overflow-hidden d-block bg-light">
                                    <img class="w-100 img-fluid position-relative z-index-10" title="" src="/images/products/product-5.jpg" alt="">
                                </picture>
                                    <div class="position-absolute start-0 bottom-0 end-0 z-index-20 p-2">
                                        <button class="btn btn-quick-add"><i class="ri-add-line me-2"></i> Quick Add</button>
                                    </div>
                            ...
                            <div class="card-body px-0">
                                <a class="text-decoration-none link-cover" href="product.blade.php">Nike Air Max 90</a>
                                <small class="text-muted d-block">4 colours, 10 sizes</small>
                    ...
                    <div class="col-12 col-sm-6 col-lg-4">
                        ...
                        <div class="card border border-transparent position-relative overflow-hidden h-100 transparent">
                            <div class="card-img position-relative">
                                ...
                                <span class="position-absolute top-0 end-0 p-2 z-index-20 text-muted"><i class="ri-heart-line"></i></span>
                                <picture class="position-relative overflow-hidden d-block bg-light">
                                    <img class="w-100 img-fluid position-relative z-index-10" title="" src="/images/products/product-6.jpg" alt="">
                                </picture>
                                    <div class="position-absolute start-0 bottom-0 end-0 z-index-20 p-2">
                                        <button class="btn btn-quick-add"><i class="ri-add-line me-2"></i> Quick Add</button>
                                    </div>
                            ...
                            <div class="card-body px-0">
                                <a class="text-decoration-none link-cover" href="product.blade.php">Nike Glide FlyEase</a>
                    ...
                    <div class="col-12 col-sm-6 col-lg-4">
                        ...
                        <div class="card border border-transparent position-relative overflow-hidden h-100 transparent">
                            <div class="card-img position-relative">
                                ...
                                <span class="position-absolute top-0 end-0 p-2 z-index-20 text-muted"><i class="ri-heart-line"></i></span>
                                <picture class="position-relative overflow-hidden d-block bg-light">
                                    <img class="w-100 img-fluid position-relative z-index-10" title="" src="/images/products/product-7.jpg" alt="">
                                </picture>
                                    <div class="position-absolute start-0 bottom-0 end-0 z-index-20 p-2">
                                        <button class="btn btn-quick-add"><i class="ri-add-line me-2"></i> Quick Add</button>
                                    </div>
                            ...
                            <div class="card-body px-0">
                                <a class="text-decoration-none link-cover" href="product.blade.php">Nike Zoom Freak</a>
                    ...
                    <div class="col-12 col-sm-6 col-lg-4">
                        ...
                        <div class="card border border-transparent position-relative overflow-hidden h-100 transparent">
                            <div class="card-img position-relative">
                                ...
                                <span class="position-absolute top-0 end-0 p-2 z-index-20 text-muted"><i class="ri-heart-line"></i></span>
                                <picture class="position-relative overflow-hidden d-block bg-light">
                                    <img class="w-100 img-fluid position-relative z-index-10" title="" src="/images/products/product-8.jpg" alt="">
                                </picture>
                                    <div class="position-absolute start-0 bottom-0 end-0 z-index-20 p-2">
                                        <button class="btn btn-quick-add"><i class="ri-add-line me-2"></i> Quick Add</button>
                                    </div>
                            ...
                            <div class="card-body px-0">
                                <a class="text-decoration-none link-cover" href="product.blade.php">Nike Air Pegasus</a>
                    ...
                    <div class="col-12 col-sm-6 col-lg-4">
                        ...
                        <div class="card border border-transparent position-relative overflow-hidden h-100 transparent">
                            ...
                            <div class="card-body px-0">
                                <a class="text-decoration-none link-cover" href="product.blade.php">Nike Air Jordans</a>
                                <small class="text-muted d-block">3 colours, 10 sizes</small>
