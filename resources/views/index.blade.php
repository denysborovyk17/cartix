    ...
    <div class="container-fluid">
        ...
        <div class="position-relative row my-lg-7 pt-5 pt-lg-0 g-8">
            ...
            <div class="col-12 col-md-6 position-relative z-index-20 mb-7 mb-lg-0" data-aos="fade-right">
                ...
                <h3 class="display-3 fw-bold mb-5"><span class="text-outline-dark">Cartix</span> - streetwear & footwear specialists</h3>
                <p class="lead">We are Cartix, a leading supplier of global streetwear brands, including names such as <a href="./category.html">Stussy</a>, <a href="./category.html">Carhartt</a>, <a href="./category.html">Gramicci</a>, <a href="./category.html">Afends</a> and many more.</p>
