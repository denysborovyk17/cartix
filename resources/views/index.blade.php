              ...
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide position-relative h-100 w-100">
                  ...
                  <div
                    ...
                    <div data-swiper-parallax-y="-25">
                      <a href="category.blade.php" class="btn btn-psuedo text-white" role="button">Shop New Arrivals</a>
                    </div>
                  </div>
                </div>
                <!-- /Slide-->
                ...
                <div class="swiper-slide position-relative h-100 w-100">
                  ...
                  <div
                    ...
                    <div data-swiper-parallax-y="-25">
                      <a href="category.blade.php" class="btn btn-psuedo text-white" role="button">Shop Latest Adidas</a>
                    </div>
                  </div>
                </div>
                <!--/Slide-->
                ...
                <div class="swiper-slide position-relative h-100 w-100">
                  ...
                  <div
                    ...
                    <div data-swiper-parallax-y="-25">
                      <a href="category.blade.php" class="btn btn-psuedo text-white" role="button">Shop Latest Nike</a>
                    </div>
                  </div>
                </div>
                <!-- /Slide-->
                ...
                <div class="swiper-slide position-relative h-100 w-100">
                  ...
                  <div
                    ...
                    <div data-swiper-parallax-y="-25">
                      <a href="category.blade.php" class="btn btn-psuedo text-white" role="button">Why We Are Different</a>
                    </div>
                  </div>
                </div>
                <!--/Slide-->
                    ...
                    <div class="marquee-body">
                        <div class="marquee-section animation-marquee-50">
                            ...
                            <div class="mx-3 mx-lg-5 f-w-24">
                                <a class="d-block" href="category.blade.php">
                                    <picture>
                                        <img class="img-fluid d-table mx-auto" src="/images/logos/logo-7.svg" alt="">
                                    </picture>
                                </a>
                            </div>
                            <div class="mx-3 mx-lg-5 f-w-24">
                                <a class="d-block" href="category.blade.php">
                                    <picture>
                                        <img class="img-fluid d-table mx-auto" src="/images/logos/logo-8.svg" alt="">
                                    </picture>
                                </a>
                            </div>
                            <div class="mx-3 mx-lg-5 f-w-24">
                                <a class="d-block" href="category.blade.php">
                                    <picture>
                                        <img class="img-fluid d-table mx-auto" src="/images/logos/logo-9.svg" alt="">
                                    </picture>
                                </a>
                            </div>
                        </div>
        ...
        <div class="container-fluid">
                      ...
                      <div class="swiper-wrapper">
                          <div class="swiper-slide align-self-stretch bg-transparent h-auto">
                            <div class="me-xl-n4 me-xxl-n5" data-aos="fade-up" data-aos-delay="000">
                                ...
                                <a href="category.blade.php" class="btn btn-psuedo align-self-start">Shop Now</a>
                            </div>
                          </div>
                          <div class="swiper-slide align-self-stretch bg-transparent h-auto">
            ...
            <div class="position-relative row my-lg-7 pt-5 pt-lg-0 g-8">
                ...
                <div class="col-12 col-md-6 position-relative z-index-20 mb-7 mb-lg-0" data-aos="fade-right">
                    ...
                    <p class="lead">We are OldSkool, a leading supplier of global streetwear brands, including names such as <a href="category.blade.php">Stussy</a>, <a href="category.blade.php">Carhartt</a>, <a href="category.blade.php">Gramicci</a>, <a href="category.blade.php">Afends</a> and many more.</p>
                    <p class="lead">With worldwide shipping and unbeatable prices - now's a great time to pick out something from our range.</p>
                    <a href="category.blade.php" class="btn btn-psuedo" role="button">Shop New Arrivals</a>
                </div>
                <div class="col-12 col-md-6 position-relative z-index-20 pe-0" data-aos="fade-left">
                    <picture class="w-50 d-block position-relative z-index-10 border border-white border-4 shadow-lg">
                        <img class="img-fluid" src="/images/banners/banner-5.jpg" alt="HTML Bootstrap Template by Pixel Rocket">
                    </picture>
                    <picture class="w-60 d-block me-8 mt-n10 shadow-lg border border-white border-4 position-relative z-index-20 ms-auto">
                        <img class="img-fluid" src="/images/banners/banner-6.jpg" alt="HTML Bootstrap Template by Pixel Rocket">
                    </picture>
                    <picture class="w-50 d-block me-8 mt-n7 shadow-lg border border-white border-4 position-absolute top-0 end-0 z-index-0 ">
                        <img class="img-fluid" src="/images/banners/banner-7.jpg" alt="HTML Bootstrap Template by Pixel Rocket">
                    </picture>
                </div>
            </div>
            <!-- / Homepage Intro-->
                ...
                <div class="row g-4">
                    <div class="col-12 col-xl-6 position-relative" data-aos="fade-right">
                        <picture class="position-relative z-index-10">
                            <img class="w-100 rounded" src="/images/banners/banner-sale.jpg" alt="HTML Bootstrap Template by Pixel Rocket">
                        </picture>
                        <div class="position-absolute top-0 bottom-0 start-0 end-0 d-flex justify-content-center align-items-center z-index-20">
                            <div class="py-6 px-5 px-lg-10 text-center w-100">
                                ...
                                <a href="category.blade.php" class="btn btn-psuedo text-white" role="button">Shop All Sale Items</a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-12 col-md-6 d-flex">
                                <div class="card position-relative overflow-hidden">
                                    <picture class="position-relative z-index-10 d-block bg-light">
                                        <img class="w-100 rounded" src="/images/banners/banner-8.jpg" alt="HTML Bootstrap Template by Pixel Rocket">
                                    </picture>
                                    <div class="card-overlay">
                                        <p class="lead fw-bolder mb-2">The Jordan Delta 2</p>
                                        <a href="category.blade.php" class="btn btn-psuedo text-white py-2" role="button">Shop Kicks</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-6 d-flex">
                                <div class="card position-relative overflow-hidden">
                                    <picture class="position-relative z-index-10 d-block bg-light">
                                        <img class="w-100 rounded" src="/images/banners/banner-9.jpg" alt="HTML Bootstrap Template by Pixel Rocket">
                                    </picture>
                                    <div class="card-overlay">
                                        <p class="lead fw-bolder mb-2">Latest Mens Shirts</p>
                                        <a href="category.blade.php" class="btn btn-psuedo text-white py-2" role="button">Shop New</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-6 d-flex">
                                <div class="card position-relative overflow-hidden">
                                    <picture class="position-relative z-index-10 d-block bg-light">
                                        <img class="w-100 rounded" src="/images/banners/banner-10.jpg" alt="HTML Bootstrap Template by Pixel Rocket">
                                    </picture>
                                    <div class="card-overlay">
                                        <p class="lead fw-bolder mb-2">KiiKii Osake Tees</p>
                                        <a href="category.blade.php" class="btn btn-psuedo text-white py-2" role="button">Shop T-Shirts</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-6 d-flex">
                                <div class="card position-relative overflow-hidden">
                                    <picture class="position-relative z-index-10 d-block bg-light">
                                        <img class="w-100 rounded" src="/images/banners/banner-11.jpg" alt="HTML Bootstrap Template by Pixel Rocket">
                                    </picture>
                                    <div class="card-overlay">
                                        <p class="lead fw-bolder mb-2">Multibuy Womens Shirts</p>
                                        <a href="category.blade.php" class="btn btn-psuedo text-white py-2" role="button">Shop Sale Items</a>
                                    </div>
                                </div>
                            </div>
                        </div>
