...
### Додано
- Ідентифікатор варіанта продукту як query-параметер в URL (підготовка до динамічного відображення опцій).
...
### Додано
- Blade-шаблон `cart-item` для відображення картки товару в кошику.
...
- Логіку підрахунку кількості товарів в кошику в методі `getItemsCount` сервісу `CartService`.
